...
class DatadogSetup():
    ...
    def install_datadog(datadog_api_key):
        ...
        datadogHelmChartAddCmd = 'helm repo add datadog https://helm.datadoghq.com && helm repo update'
        datadogHelmChartAddSubprocess = subprocess.run(datadogHelmChartAddCmd, shell=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE)
        ...
        installDatadogSubprocess = subprocess.run(installDatadogCmd, shell=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE)
    ...
    def uninstall_datadog():
        ...
        datadogRemoveSubprocess = subprocess.run(datadogRemoveCmd, shell=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE)
